export const changelog_en = {
  '1.2.0': {
    ...
    fixes: [
      {
        change: "fixed problems with the chat post from the @Info​[] enricher from the dsa5 system",
        explanations: []
      },
    ]
  },
  '1.1.0': {
    ...
    additions: [
      {
        change: "JournalEntry with introduction and further instructions for enrichers (English and German)",
        explanations: []
      },
    ],
    fixes: [
      {
        change: "Fixed small issues that occured in combination with \"Yendor's UI\"",
        explanations: []
      },
    ]
  },
...
export const changelog_de = {
  '1.2.0': {
    ...
    additions: [
      ...
      {
        change: "Der @Page Enricher, mit dem der Inhalt einer anderen Seite eingefügt werden kann",
        explanations: [
    ...
    fixes: [
      {
        change: "Probleme mit dem Chatpost des @Info​[] Enrichers aus dem DSA5 System wurden behoben",
        explanations: []
      },
    ]
  },
  '1.1.0': {
    ...
    additions: [
      {
        change: "JournalEntry mit Einführung und weiteren Informationen wurde erstellt (Englisch und Deutsch)",
        explanations: []
      },
    ],
    fixes: [
