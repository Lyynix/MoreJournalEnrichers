[![GitHub release (latest by SemVer and asset)](https://img.shields.io/github/downloads/Lyynix/MoreJournalEnrichers/v1.3.0/lmje.zip)](https://github.com/Lyynix/MoreJournalEnrichers/releases/download/v1.3.0/manifest.json)
